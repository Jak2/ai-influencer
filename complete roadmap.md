...
```mermaid
graph LR
    A[IMAGE GEN - SeaArt/Leonardo] --> B[CONSISTENCY - LoRA Training]
    B --> C[VIDEO/LIPSYNC - APOB/HeyGen]
    A --> D[CAPTIONS - ChatGPT Persona]
    B --> E[AUTOMATION - Make/Zapier]
    C --> F[SCHEDULING - Buffer/Later]
